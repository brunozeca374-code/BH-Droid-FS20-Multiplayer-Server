...
## Bridge V7 — diagnóstico de entrada

A V7 mantém o mesmo protocolo de salas da V6 e adiciona log no servidor sempre que um cliente pede os detalhes de uma sala online, registrando `room`, IP público do cliente e `target=IP:porta` entregue. Isso não é um relay UDP; serve para confirmar o roteamento antes do socket nativo 10823.
